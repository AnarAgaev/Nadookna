...
<head>
    ...
    <meta name="description" content="Самый полный оконный словарь Пластиковых ПВХ окон <?php echo $_SESSION['morph']['gde']; ?>. Слова на букву 'Р'">
    <meta name="keywords" content="ручка, рольставни, регулируемое проветривание, рафшторы, расширительный профиль, рамочная конструкция, рама">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>Оконный словарь - буква "Р".</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="title_col">
			...
			<div>
				<h1 class="tit_text">Оконный словарь<br>Слова на букву "Р"</h1>
		...
		<div class="dictionary">
			<p>
				<h2 class="word_dict">Рама </h2>
				- смотри "Коробка" на букву "К" в этом словаре.
			</p>
			<p>
				<h2 class="word_dict">Рамочная конструкция </h2>
				- то же самое, что рама и коробка.
			</p>
			<p>
				<h2 class="word_dict">Расширительный профиль </h2>
				- смотри "Доборный профиль" на букву "Д" в этом словаре.
			</p>
			<p>
				<h2 class="word_dict">Рафшторы </h2>
				- это своего рода жалюзи (смотри "Жалюзи" в этом словаре) но которые устанавливаются 
				на окна не внутри помещения, а снаружи и служат для защиты <a class="for_txt" href="../">пластиковых окон</a> от повреждения.
			</p>
			<p>
				<h2 class="word_dict">Регулируемое проветривание </h2>
				- это обеспечение циркуляции воздуха внутри помещения с определенной интенсивностью и кратностью. 
				Для создания регулируемого проветривания производители прибегают к различным конструктивным решения. 
				Наиболее распространённое из них это створка или форточка с регулируемым ограничителем открывания, 
				а так же клапанная створка или климабокс.
			</p>
			<p>
				<h2 class="word_dict">Рольставни </h2>
				- это разновидность жалюзи, которые устанавливаются снаружи помещения на окна и основной функцией 
				которых является защита помещения от проникновения. Рольставни представляют собой сворачиваемое 
				в рулон полотно, которое перемещается по специальным направляющим, размещенным на боковых торцах 
				проёма. В открытом состоянии рольставни спрятаны в специальный корпус, установленный в верхней сверху.
			</p>
			<p>
				<h2 class="word_dict">Ручка </h2>
				- рычажный элемент <a class="for_txt" href="../">пластикового окна</a> позволяющий передать 
				усилие человека на открывающий механизм створки из одной точки.
				С помощью ручки производятся такие операции как открытие, 
				закрытие и откидывание створки.
