...
<head>
    ...
    <meta name="description" content="Самый полный оконный словарь Пластиковых ПВХ окон <?php echo $_SESSION['morph']['gde']; ?>. Слова на букву 'Ж'">
    <meta name="keywords" content="жидкие гвозди, жалюзи">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>Оконный словарь - буква "Ж".</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="title_col">
			...
			<div>
				<h1 class="tit_text">Оконный словарь<br>Слова на букву "Ж"</h1>
		...
		<div class="dictionary">
			<p>
				<h2 class="word_dict">Жалюзи </h2>
				- это изделие выполняет функцию штор и представляет собой набор из 
				горизонтальных или вертикальных пластин из металла или пластика. 
				Движение жалюзи производится с помощью специального механизма. 
				Жалюзи, как правило, не прозрачны и служат как преграда для света и 
				крепятся на внутреннюю сторону 
				<a class="for_txt" href="../">пластикового окна</a>.
			</p>
			<p>
				<h2 class="word_dict">Жидкие гвозди </h2>
				- это распространённое название клея, особенностью которого является 
				повышенная адгезия (удерживающая способность). Жидкие гвозди наносят на 
				склеиваемые поверхности не сплошным слоем, а точечно в те места, 
				где забивают гвозди или дюбели.
			</p>
		</div>
