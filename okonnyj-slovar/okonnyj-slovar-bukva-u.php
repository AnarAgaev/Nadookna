...
<head>
    ...
    <meta name="description" content="Самый полный оконный словарь Пластиковых ПВХ окон <?php echo $_SESSION['morph']['gde']; ?>. Слова на букву 'У'">
    <meta name="keywords" content="уплотнитель">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>Оконный словарь - буква "У".</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="title_col">
			...
			<div>
				<h1 class="tit_text">Оконный словарь<br>Слова на букву "У"</h1>
		...
		<div class="dictionary">
			<p>
				<h2 class="word_dict">Уплотнитель </h2>
				- это резиновый или силиконовый шнур для герметизации стыков 
				между деталями <a class="for_txt" href="../">пластикового окна</a>.
				Уплотнитель крепится к раме или створке в местах их примыкания, 
				а также между стеклопакетом и створкой.
