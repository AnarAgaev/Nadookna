...
<head>
    ...
    <meta name="description" content="Самый полный оконный словарь Пластиковых ПВХ окон <?php echo $_SESSION['morph']['gde']; ?>. Слова на букву 'Ш'">
    <meta name="keywords" content="ширина подоконника, ширина отлива, ширина откосов, ширина окна, штапик">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>Оконный словарь - буква "Ш".</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="title_col">
			...
			<div>
				<h1 class="tit_text">Оконный словарь<br>Cлова на букву "Ш"</h1>
		...
		<div class="dictionary">
			<p>
				<h2 class="word_dict">Штапик </h2>
				- это оконный профиль неправильной формы небольшого сечения, от 1 до 2,5 см. в диаметре, 
				предназначенный для закрепления 
				оконного стеклопакета в раме, располагаясь по его периметру. Благодаря тому, что он может 
				быть в любой момент демонтирован, делает более удобным монтаж 
				<a class="for_txt" href="../">пластикового окна</a> в оконном проёме, так 
				как позволяет в любой момент вынуть стеклопакет из рамы. Штапик крепится в специальные 
				фальцы (защёлки) на оконной раме, благодаря чему надёжно крепит оконный стеклопакет в 
				раме и препятствует его выпадению под действием различный нагрузок. По краю штапика, 
				между ним и стеклом, располагается резиновый уплотнитель серого или черного цвета, 
				обеспечивающий плотное прилегание и отсутствие люфтов стеклопакета в раме.
			</p>
			<p>
			<h2 class="word_dict">Ширина окна </h2>
				- расстояние между левым и правым откосами. Строго говоря, это не совсем так, но для наших целей,
				а именно для самостоятельного замера 
				<a class="for_txt" href="../">пластикового окна</a> 
				пред обращение в оконную компанию, такое определение подойдёт.
			</p>
			<p>
			<h2 class="word_dict">Ширина откосов </h2>
				- это глубина внутренней стены от рамы до края стены слева, справа или сверху от окна.
			</p>
			<p>
			<h2 class="word_dict">Ширина отлива </h2>
				- смотри глубина отлива, выше в этом словаре.
			</p>
			<p>
			<h2 class="word_dict">Ширина подоконника </h2>
				- смотри глубина подоконника, выше в этом словаре.
			</p>
		</div>
