...
<head>
    ...
    <meta name="description" content="Самый полный оконный словарь Пластиковых ПВХ окон <?php echo $_SESSION['morph']['gde']; ?>. Слова на букву 'Ф'">
    <meta name="keywords" content="фурнитура">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>Оконный словарь - буква "Ф".</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="title_col">
			...
			<div>
				<h1 class="tit_text">Оконный словарь<br>Слова на букву "Ф"</h1>
		...
		<div class="dictionary">
			<p>
				<h2 class="word_dict">Фурнитура </h2>
				- это механизм, располагающаяся по периметру створки и внутри рамы, 
				задачей которого является управление <a class="for_txt" href="../">пластиковым окном</a>, его запирание, 
				отпирание, откидывание и поворот.
