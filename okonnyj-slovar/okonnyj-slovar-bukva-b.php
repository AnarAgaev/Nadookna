...
<head>
    ...
    <meta name="description" content="Самый полный оконный словарь Пластиковых ПВХ окон <?php echo $_SESSION['morph']['gde']; ?>. Слова на букву 'Б'">
    <meta name="keywords" content="базовая подкладка, выравнивающая подкладка, балка, балконный блок, блокировщик открытия, брусок, бутил">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>Оконный словарь - буква "Б".</title>
...
<body>
	...
	<div id="wrapper">
		...
		<div class="title_col">
			...
			<div>
				<h1 class="tit_text">Оконный словарь<br>Слова на букву "Б"</h1>
		...
		<div class="dictionary">
			<p>
				<h2 class="word_dict">Базовая (выравнивающая) подкладка </h2> 
				- устанавливаемый под опорными подкладками элемент выравнивания откосов.
			</p>
			<p>
				<h2 class="word_dict">Балка </h2> 
				- это элемент створки рамы, который представляют собой часть профиля образующий контур пластикового окна.
			</p>
			<p>
				<h2 class="word_dict">Балконный блок </h2> 
				- это соединённые вместе балконная дверь и окно.
			</p>
			<p>
				<h2 class="word_dict">Блокировщик открытия </h2> 
				- фурнитурный механизм, предохраняющий от неправильного открытия створки 
				<a class="for_txt" href="../">пластикового окна</a> и 
				позволяющий последовательно менять типы открытия окна, при этом створка повисает на нижней петле.
			</p>
			<p>
				<h2 class="word_dict">Брусок </h2> 
				- профильная деталь створки, коробки, обвязки.
			</p>
			<p>
				<h2 class="word_dict">Бутил </h2> 
				- герметизирующий слой, служащий связующей частью между рамкой и стеклом.
			</p>
		</div>
