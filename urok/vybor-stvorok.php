...
<head>
	...
	<title>Выбор створок пластиковых окон <?php echo $_SESSION['morph']['gde']; ?>.</title>
	<meta name="description" content="Не знаете как купить окна ПВХ?. БЕСПЛАТНО расскажем как купить окна. Выбор створок.">
	<meta name="keywords" content="выбор створок">    
	...
	<div id="wrapper">
		...
		<div class="content_wrap">
			...
			<div class="line_course">
				...
				<h1 class="tit_les">Как купить окна: выбор створок.</h1>
			</div>
			...
			<div class="list_urok">
				...
				<div class="point_urok">
					...
					<a style="color: #4285f4;" class="point_urok" href="vybor-stvorok.php">Выбор створок</a>
				</div>
				<div class="point_urok">
			...
			<div class="txt_articl">
				<p class="txt_articl">На втором этапе необходимо определиться со створками. Чтобы выбрать оптимальное количество створок и типы их открывания, представьте, как Вы будете использовать будущие <a class="for_txt" href="../">пластиковые окна</a>. Должно быть удобно не только открывать и закрывать окна, но и проветривать и мыть. Запишите типы открывания створок, согласно классификации показанной в <a class="for_txt" href="stvorki-plastikovyh-okon.php">Уроке 2</a>.</p>
				<p class="nest_part">Далее Чать 3: <a class="nest_part" href="otkosy-podokonnik-otliv.php">Откосы, подоконник, отлив.</a></p>
			</div>
			<a class="go_to_next_part roundBorder" href="otkosy-podokonnik-otliv.php">Откосы, подоконник, отлив.</a>
